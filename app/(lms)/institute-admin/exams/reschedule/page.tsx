    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <SectionHeader title="Reschedule Management" subtitle="Submit new requests or track existing ones." />
            </div>
                ...
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>All reschedule requests submitted by your institute.</CardDescription>
                        </CardHeader>
                        <CardContent>
                                    ...
                                    <TableBody>
                                        {existingRequests.map((req: any) => (
                                            <TableRow key={req._id}>
                                                <TableCell>
                                                    <div>
                                                        <div className="font-medium">{req.studentId?.name || 'Unknown'}</div>
                                                        <div className="text-xs text-muted-foreground">{req.studentId?.rollNo}</div>
                                                    </div>
                                                </TableCell>
                                                <TableCell>
                                                    <div className="text-sm">
                                                        {req.originalExamId?.title || 'Unknown Exam'}
                                                    </div>
                                                    <div className="text-xs text-muted-foreground">
                                                        {req.originalExamId?.date ? new Date(req.originalExamId.date).toLocaleDateString() : ''}
                                                    </div>
                                                </TableCell>

...
import { Calendar, FileCheck, Timer, Clock, Award, Users, AlertCircle, RefreshCw, Trash2, Edit, CheckCircle, XCircle, MoreVertical, MapPin } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-2">
        <Button asChild className="gap-2">
          <Link href="/super-admin/exams/schedule">
                  ...
                  <Card key={exam._id} className="hover:shadow-lg transition-all border-l-4 border-l-orange-500 overflow-hidden group">
                    <CardContent className="p-0">
                      <div className="p-4 border-b bg-muted/5 flex items-start justify-between">
                        <div className="space-y-1.5">
                          <div className="flex items-center gap-2">
                            <div className="p-2 bg-orange-100 dark:bg-orange-900/30 rounded-lg group-hover:scale-105 transition-transform">
                        ...
                        <div className="flex flex-col items-end gap-1.5">
                          <Badge variant="outline" className="bg-orange-50 border-orange-200 text-orange-700 dark:bg-orange-900/20 dark:text-orange-400 dark:border-orange-800">
                            {rescheduledCount} Students Rescheduled
                          </Badge>
                          {exam.attendanceEnabled && (
                            <Badge variant="outline" className="bg-green-50 border-green-200 text-green-700 dark:bg-green-900/20 dark:text-green-400 dark:border-green-800">
                              ✓ Attendance Active
                            </Badge>
                          )}
                        </div>
                      ...
                      <div className="p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div className="p-3 bg-red-50 dark:bg-red-950/30 rounded-lg border border-red-100 dark:border-red-900/50">
                          <p className="text-[10px] text-red-600 dark:text-red-400 font-bold uppercase tracking-wider mb-2">Original Schedule</p>
                          <div className="space-y-1">
                            <div className="flex items-center gap-2 text-red-700 dark:text-red-300">
                              <Calendar className="w-3.5 h-3.5" />
                              <span className="font-medium text-sm">{new Date(exam.date).toLocaleDateString()}</span>
                            </div>
                        ...
                        <div className="p-3 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-100 dark:border-green-900/50">
                          <p className="text-[10px] text-green-600 dark:text-green-400 font-bold uppercase tracking-wider mb-2">New Schedule</p>
                          {exam.rescheduledDate ? (
                            <div className="space-y-1">
                              <div className="flex items-center gap-2 text-green-700 dark:text-green-300">
                                <Calendar className="w-3.5 h-3.5" />
                                <span className="font-medium text-sm">{new Date(exam.rescheduledDate).toLocaleDateString()}</span>
                              </div>
                              <div className="flex items-center gap-2 text-green-600 dark:text-green-400 text-xs">
                                <Clock className="w-3.5 h-3.5" />
                                <span>{exam.rescheduledStartTime} - {exam.rescheduledEndTime}</span>
                              </div>
                            </div>
                          ) : (
                        ...
                        <div className="flex items-center gap-3 pl-2">
                          ...
                          <div>
                            <p className="text-xs text-muted-foreground uppercase tracking-wider font-semibold">Total Students</p>
                      ...
                      <div className="p-3 bg-muted/10 border-t flex flex-wrap justify-end gap-2">
                        ...
                        <Button
                          size="sm"
                          variant="outline"
                          onClick={() => window.location.href = `/super-admin/exams/reschedule?examId=${exam._id}&view=edit`}
                        >
                          <Edit className="w-3.5 h-3.5 mr-1.5" />
                          Edit
                        </Button>
                ...
                <Card key={exam._id} className="hover:shadow-lg transition-all border-l-4 border-l-purple-500 overflow-hidden group">
                  <CardContent className="p-0">
                    ...
                    <div className="p-3 bg-muted/10 border-t flex flex-wrap justify-end gap-2">
                      ...
                      <Button size="sm" variant="destructive" onClick={() => handleDeleteExam(exam._id)}>
                        <Trash2 className="w-3.5 h-3.5 mr-1.5" />
                        Delete
                      </Button>
                    </div>
          ...
          {selectedExam && (
            <form onSubmit={handleUpdateExam} className="space-y-4">
              <div>
                ...
                <Input id="edit-title" name="title" defaultValue={selectedExam.title} required />
              </div>
              <div>
              ...
              <div>
                ...
                <Input id="edit-duration" name="duration" type="number" defaultValue={selectedExam.duration} required />
              </div>
              <div>
                <Label htmlFor="edit-totalMarks">Total Marks</Label>
                <Input id="edit-totalMarks" name="totalMarks" type="number" defaultValue={selectedExam.totalMarks} required />
              </div>
              <div>
